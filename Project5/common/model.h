...
public:
    ...
    Drawable(
        ...
        const std::vector<glm::vec3>& tangents = VEC_VEC3_DEFAUTL_VALUE);
...
public:
    std::vector<glm::vec3> vertices, normals,tangents, indexedVertices, indexedNormals,indexedTangents;
    std::vector<glm::vec2> uvs, indexedUVS;
    std::vector<unsigned int> indices;

    GLuint VAO, verticesVBO, uvsVBO, normalsVBO,tangentsVBO, elementVBO;
